  ...
  return (
    <main className="relative min-h-screen max-w-[390px] mx-auto flex flex-col items-center justify-center px-6">
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute w-[420px] h-[420px] rounded-full bg-blush/45 blur-[90px] -top-28 -right-20 animate-[drift_14s_ease-in-out_infinite]" />
        <div className="absolute w-[340px] h-[340px] rounded-full bg-lavender/40 blur-[80px] bottom-8 -left-20 animate-[drift_17s_ease-in-out_infinite_2s]" />
        <div className="absolute w-[200px] h-[200px] rounded-full bg-warm/35 blur-[60px] top-1/2 left-1/2 -translate-x-1/2 animate-[drift_11s_ease-in-out_infinite_1s]" />
      </div>
      ...
      <div className="relative z-10 w-full animate-[fadeUp_0.5s_ease_both]">
        ...
        <div className="glass rounded-3xl p-6 shadow-sm">
          <h2 className="font-serif text-2xl font-light text-text-main mb-1">Selamat datang</h2>
          <p className="text-[12px] text-muted mb-6">Masuk ke akun kamu</p>
        ...
        <p className="text-center text-[12px] text-muted mt-5">
          Belum punya akun?{' '}
          <Link href="/auth/register" className="text-rose-deep font-medium hover:underline">
            Daftar sekarang
          </Link>
        </p>
      </div>
